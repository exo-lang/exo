  ...
  for (int_fast32_t jo = 0; jo < ((m) / (256)); jo++) {
    for (int_fast32_t ii = 0; ii < 132; ii++) {
      for (int_fast32_t ji = 0; ji < 256; ji++) {
        f[ii * 256 + ji] = (inp[(ii + 128 * io) * (m + 4) + ji + 256 * jo] + inp[(ii + 128 * io) * (m + 4) + 1 + ji + 256 * jo] + inp[(ii + 128 * io) * (m + 4) + 2 + ji + 256 * jo] + inp[(ii + 128 * io) * (m + 4) + 3 + ji + 256 * jo] + inp[(ii + 128 * io) * (m + 4) + 4 + ji + 256 * jo]) / 5;
      }
    }
    for (int_fast32_t ii = 0; ii < 128; ii++) {
      for (int_fast32_t ji = 0; ji < 256; ji++) {
        g[(ii + 128 * io) * (m + 4) + ji + 256 * jo] = (f[ii * 256 + ji] + f[(1 + ii) * 256 + ji] + f[(2 + ii) * 256 + ji] + f[(3 + ii) * 256 + ji] + f[(4 + ii) * 256 + ji]) / 5;
      }
    }
  }
}
