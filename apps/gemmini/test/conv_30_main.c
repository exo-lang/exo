...
static int8_t output_cpu[4 * 14 * 14 * 256];
static int8_t output_gemmini[4 * 14 * 14 * 256];
...
int main() {
  ...
  for (int i = 0; i < 4; i++) {
    for (int j = 0; j < 14; j++) {
      for (int k = 0; k < 14; k++) {
        for (int r = 0; r < 256; r++) {
          output_cpu[(14 * 14 * 256) * i + (14 * 256) * j + (256) * k + r] = 0;
        }
      }
    }
  }
  ...
  for (int i = 0; i < 4; i++) {
    for (int j = 0; j < 14; j++) {
      for (int k = 0; k < 14; k++) {
        for (int r = 0; r < 256; r++) {
          output_gemmini[(14 * 14 * 256) * i + (14 * 256) * j + (256) * k + r] =
              0;
        }
      }
    }
