...
void matmul_c_i8( int N, int M, int K, float* a_scale, float* b_scale, float* c_scale, int8_t* acc, int8_t* trans_a, int8_t* trans_b, struct systl_win_2i8 A, struct systl_win_2i8 B, struct systl_win_2i8 C ) {
...
void matmul_c_i8_d_i8_rep( int N, int M, int K, float* a_scale, float* b_scale, float* c_scale, float* d_scale, int8_t* acc, int8_t* trans_a, int8_t* trans_b, struct systl_win_2i8 A, struct systl_win_2i8 B, struct systl_win_2i8 C, struct systl_win_2i8 D ) {
for (int i=0; i < _floor_div(N, 16); i++) {
  for (int j=0; j < _floor_div(M, 16); j++) {
    int32_t *res = (int32_t*) ((uint32_t)gemm_acc_malloc (16 * 16 * sizeof(int32_t)));
    for (int l=0; l < 16; l++) {
...
void matmul_c_i8_d_i8( int N, int M, int K, float* a_scale, float* b_scale, float* c_scale, float* d_scale, int8_t* acc, int8_t* trans_a, int8_t* trans_b, struct systl_win_2i8 A, struct systl_win_2i8 B, struct systl_win_2i8 C, struct systl_win_2i8 D ) {
for (int i=0; i < _floor_div(N, 16); i++) {
  for (int j=0; j < _floor_div(M, 16); j++) {
    int32_t *res = (int32_t*) ((uint32_t)gemm_acc_malloc (16 * 16 * sizeof(int32_t)));
...
void matmul_c_i8_d_i32( int N, int M, int K, float* a_scale, float* b_scale, float* c_scale, float* d_scale, int8_t* acc, int8_t* trans_a, int8_t* trans_b, struct systl_win_2i8 A, struct systl_win_2i8 B, struct systl_win_2i8 C, struct systl_win_2i32 D ) {
for (int i=0; i < _floor_div(N, 16); i++) {
  for (int j=0; j < _floor_div(M, 16); j++) {
    int32_t *res = (int32_t*) ((uint32_t)gemm_acc_malloc (16 * 16 * sizeof(int32_t)));
...
void matmul_c_i32( int N, int M, int K, float* a_scale, float* b_scale, int8_t* acc, int8_t* trans_a, int8_t* trans_b, struct systl_win_2i8 A, struct systl_win_2i8 B, struct systl_win_2i32 C ) {
for (int i=0; i < _floor_div(N, 16); i++) {
  for (int j=0; j < _floor_div(M, 16); j++) {
    int32_t *res = (int32_t*) ((uint32_t)gemm_acc_malloc (16 * 16 * sizeof(int32_t)));
    gemmini_extended3_config_ld(0, 1.0f, 0, 0);
...
gemmini_extended_compute_preloaded((uint32_t)(((struct systl_win_2i8){ (int8_t*)((uint64_t)( ((uint32_t)((uint64_t)Ablock_1)) + ((0) * (16) + (0) * (1))/16 )), 16,1 }).data), ~((uint32_t)0), (K % 16), (16), 16, 16);
    ...
    gemmini_extended_config_ex(WS, (int)(acc)[0], 0, 1.0f, 0, 1, 0, 0);
...
void matmul_c_i32_d_i8_rep( int N, int M, int K, float* a_scale, float* b_scale, float* d_scale, int8_t* acc, int8_t* trans_a, int8_t* trans_b, struct systl_win_2i8 A, struct systl_win_2i8 B, struct systl_win_2i32 C, struct systl_win_2i8 D ) {
for (int i=0; i < _floor_div(N, 16); i++) {
  for (int j=0; j < _floor_div(M, 16); j++) {
    int32_t *res = (int32_t*) ((uint32_t)gemm_acc_malloc (16 * 16 * sizeof(int32_t)));
    for (int l=0; l < 16; l++) {
...
void matmul_c_i32_d_i8( int N, int M, int K, float* a_scale, float* b_scale, float* d_scale, int8_t* acc, int8_t* trans_a, int8_t* trans_b, struct systl_win_2i8 A, struct systl_win_2i8 B, struct systl_win_2i32 C, struct systl_win_2i8 D ) {
for (int i=0; i < _floor_div(N, 16); i++) {
  for (int j=0; j < _floor_div(M, 16); j++) {
    int32_t *res = (int32_t*) ((uint32_t)gemm_acc_malloc (16 * 16 * sizeof(int32_t)));
    gemmini_extended3_config_ld(((struct systl_win_2i8){ D.data + (16 * i) * (D.strides[0]) + (16 * j) * (D.strides[1]), D.strides[0],D.strides[1] }).strides[0]*1, (d_scale)[0], 1, 0);
...
void matmul_c_i32_d_i32_rep( int N, int M, int K, float* a_scale, float* b_scale, float* d_scale, int8_t* acc, int8_t* trans_a, int8_t* trans_b, struct systl_win_2i8 A, struct systl_win_2i8 B, struct systl_win_2i32 C, struct systl_win_2i32 D ) {
for (int i=0; i < _floor_div(N, 16); i++) {
  for (int j=0; j < _floor_div(M, 16); j++) {
    int32_t *res = (int32_t*) ((uint32_t)gemm_acc_malloc (16 * 16 * sizeof(int32_t)));
    for (int l=0; l < 16; l++) {
...
void matmul_c_i32_d_i32( int N, int M, int K, float* a_scale, float* b_scale, float* d_scale, int8_t* acc, int8_t* trans_a, int8_t* trans_b, struct systl_win_2i8 A, struct systl_win_2i8 B, struct systl_win_2i32 C, struct systl_win_2i32 D ) {
for (int i=0; i < _floor_div(N, 16); i++) {
  for (int j=0; j < _floor_div(M, 16); j++) {
    int32_t *res = (int32_t*) ((uint32_t)gemm_acc_malloc (16 * 16 * sizeof(int32_t)));
    gemmini_extended3_config_ld(((struct systl_win_2i32){ D.data + (16 * i) * (D.strides[0]) + (16 * j) * (D.strides[1]), D.strides[0],D.strides[1] }).strides[0]*4, (d_scale)[0], 0, 0);
...
static void tiled_matmul_auto(size_t dim_I, size_t dim_J, size_t dim_K,
    ...
    if (D == NULL) {
        ...
        if (full_C) {
            printf("C is int32\n");
            // C is int32
            matmul_c_i32(dim_I, dim_J, dim_K, &a_scale, &b_scale, &act_, &trans_a, &trans_b, (struct systl_win_2i8){ A, stride_A, 1 }, (struct systl_win_2i8){ B, stride_B, 1 }, (struct systl_win_2i32){ C, stride_C, 1 });
        } else if (!full_C) {
            printf("C is int8\n");
            // C is int8
            matmul_c_i8(dim_I, dim_J, dim_K, &a_scale, &b_scale, &c_scale, &act_, &trans_a, &trans_b, (struct systl_win_2i8){ A, stride_A, 1 }, (struct systl_win_2i8){ B, stride_B, 1 }, (struct systl_win_2i8){ C, stride_C, 1 });
        }
    } else {
        // Four patterns depending on C and D precisions
        if (full_C & low_D) {
            ...
            if (repeating_bias) {
                matmul_c_i32_d_i8_rep(dim_I, dim_J, dim_K, &a_scale, &b_scale, &d_scale, &act_, &trans_a, &trans_b, (struct systl_win_2i8){ A, stride_A, 1 }, (struct systl_win_2i8){ B, stride_B, 1 }, (struct systl_win_2i32){ C, stride_C, 1 }, (struct systl_win_2i8){ D, stride_D, 1 });
            } else {
                matmul_c_i32_d_i8(dim_I, dim_J, dim_K, &a_scale, &b_scale, &d_scale, &act_, &trans_a, &trans_b, (struct systl_win_2i8){ A, stride_A, 1 }, (struct systl_win_2i8){ B, stride_B, 1 }, (struct systl_win_2i32){ C, stride_C, 1 }, (struct systl_win_2i8){ D, stride_D, 1 });
            }
            ...
            if (repeating_bias) {
                matmul_c_i32_d_i32_rep(dim_I, dim_J, dim_K, &a_scale, &b_scale, &d_scale, &act_, &trans_a, &trans_b, (struct systl_win_2i8){ A, stride_A, 1 }, (struct systl_win_2i8){ B, stride_B, 1 }, (struct systl_win_2i32){ C, stride_C, 1 }, (struct systl_win_2i32){ D, stride_D, 1 });
            } else {
                matmul_c_i32_d_i32(dim_I, dim_J, dim_K, &a_scale, &b_scale, &d_scale, &act_, &trans_a, &trans_b, (struct systl_win_2i8){ A, stride_A, 1 }, (struct systl_win_2i8){ B, stride_B, 1 }, (struct systl_win_2i32){ C, stride_C, 1 }, (struct systl_win_2i32){ D, stride_D, 1 });
            }
        } else if (!full_C & low_D) {
            printf("C is int8 and D is i8\n");
            if (repeating_bias) {
                matmul_c_i8_d_i8_rep(dim_I, dim_J, dim_K, &a_scale, &b_scale, &c_scale, &d_scale, &act_, &trans_a, &trans_b, (struct systl_win_2i8){ A, stride_A, 1 }, (struct systl_win_2i8){ B, stride_B, 1 }, (struct systl_win_2i8){ C, stride_C, 1 }, (struct systl_win_2i8){ D, stride_D, 1 });
            } else {
                matmul_c_i8_d_i8(dim_I, dim_J, dim_K, &a_scale, &b_scale, &c_scale, &d_scale, &act_, &trans_a, &trans_b, (struct systl_win_2i8){ A, stride_A, 1 }, (struct systl_win_2i8){ B, stride_B, 1 }, (struct systl_win_2i8){ C, stride_C, 1 }, (struct systl_win_2i8){ D, stride_D, 1 });
            }
        } else if (!full_C & !low_D) {
            ...
            if (repeating_bias) {
                ...
                matmul_c_i8_d_i32(dim_I, dim_J, dim_K, &a_scale, &b_scale, &c_scale, &d_scale, &act_, &trans_a, &trans_b, (struct systl_win_2i8){ A, stride_A, 1 }, (struct systl_win_2i8){ B, stride_B, 1 }, (struct systl_win_2i8){ C, stride_C, 1 }, (struct systl_win_2i32){ D, stride_D, 1 });
            }
        }
    }
}
