...
def inline_st(conv):
    conv = conv.call_eqv(st_acc_i8_v2, "st_acc_i8(_)")
    conv = conv.inline("st_acc_i8_v2(_)")
...
st_acc_i8_v2 = st_acc_i8_v2.configwrite_after('ConfigStore.scale = _', ConfigStore, 'dst_stride', 'stride(dst, 2)')
