...
def test_matmul_c_i8():
  ...
  def matmul_c_i8(
    ...
    for i in par(0,N/16):
        for j in par(0,M/16):
            ...
            for k in par(0,K/16):
                ...
                matmul_acc_i8(16,16,16, acc, trans_a, trans_b, Ablock, Bblock, res)
            ...
            if K%16 > 0:
                ...
                matmul_acc_i8(16,16,K%16, acc, trans_a, trans_b, Ablock, Bblock, res)
    ...
    if N%16 > 0:
        for j in par(0,M/16):
            ...
            for k in par(0,K/16):
                ...
                matmul_acc_i8(N%16,16,16, acc, trans_a, trans_b, Ablock, Bblock, res)
            ...
            if K%16 > 0:
                ...
                matmul_acc_i8(N%16,16,K%16, acc, trans_a, trans_b, Ablock, Bblock, res)
    ...
    if M%16 > 0:
        for i in par(0,N/16):
            ...
            for k in par(0,K/16):
                ...
                matmul_acc_i8(16,M%16,16, acc, trans_a, trans_b, Ablock, Bblock, res)
            ...
            if K%16 > 0:
                ...
                matmul_acc_i8(16,M%16,K%16, acc, trans_a, trans_b, Ablock, Bblock, res)
    ...
    if N%16 > 0 and M%16 > 0:
        ...
        for k in par(0,K/16):
            ...
            matmul_acc_i8(N%16,M%16,16, acc, trans_a, trans_b, Ablock, Bblock, res)
        ...
        if K%16 > 0:
            ...
            matmul_acc_i8(N%16, M%16, K%16, acc, trans_a, trans_b, Ablock, Bblock, res)
  ...
  T.add_body([f'matmul_c_i8({NN}, {MM}, {KK}, a_scale, b_scale, c_scale, 0, 0, 0, x, y, z_gemmini);',
              f'gemmini_fence();',
              f''])
...
def test_matmul_c_i32():
  ...
  T.start_timer('gemmini')
  T.add_body([f'matmul_c_i32({NN}, {MM}, {KK}, a_scale, b_scale, 0, 0, 0, x, y, z_gemmini);',
              f'gemmini_fence();',
              f''])
  T.stop_timer('gemmini', 'Cycles for GEMMINI version')
...
def test_matmul_c_i8_d_i8():
  ...
  T.start_timer('gemmini')
  T.add_body([f'matmul_c_i8_d_i8({NN}, {MM}, {KK}, a_scale, b_scale, c_scale, d_scale, 0, 0, 0, x, y, z_gemmini, d);',
              f'gemmini_fence();',
              f''])
  T.stop_timer('gemmini', 'Cycles for GEMMINI version')
...
def test_matmul_c_i8_d_i8_rep():
  ...
  T.start_timer('gemmini')
  T.add_body([f'matmul_c_i8_d_i8_rep({NN}, {MM}, {KK}, a_scale, b_scale, c_scale, d_scale, 0, 0, 0, x, y, z_gemmini, d);',
              f'gemmini_fence();',
              f''])
  T.stop_timer('gemmini', 'Cycles for GEMMINI version')
...
def test_matmul_c_i8_d_i32():
  ...
  T.start_timer('gemmini')
  T.add_body([f'matmul_c_i8_d_i32({NN}, {MM}, {KK}, a_scale, b_scale, c_scale, d_scale, 0, 0, 0, x, y, z_gemmini, d);',
              f'gemmini_fence();',
              f''])
  T.stop_timer('gemmini', 'Cycles for GEMMINI version')
...
def test_matmul_c_i32_d_i8():
  ...
  T.start_timer('gemmini')
  T.add_body([f'matmul_c_i32_d_i8({NN}, {MM}, {KK}, a_scale, b_scale, d_scale, 0, 0, 0, x, y, z_gemmini, d);',
              f'gemmini_fence();',
              f''])
  T.stop_timer('gemmini', 'Cycles for GEMMINI version')
...
def test_matmul_c_i32_d_i8_rep():
  ...
  T.start_timer('gemmini')
  T.add_body([f'matmul_c_i32_d_i8_rep({NN}, {MM}, {KK}, a_scale, b_scale, d_scale, 0, 0, 0, x, y, z_gemmini, d);',
              f'gemmini_fence();',
              f''])
  T.stop_timer('gemmini', 'Cycles for GEMMINI version')
...
def test_matmul_c_i32_d_i32():
  ...
  T.start_timer('gemmini')
  T.add_body([f'matmul_c_i32_d_i32({NN}, {MM}, {KK}, a_scale, b_scale, d_scale, 0, 0, 0, x, y, z_gemmini, d);',
              f'gemmini_fence();',
              f''])
  T.stop_timer('gemmini', 'Cycles for GEMMINI version')
...
def test_matmul_c_i32_d_i32_rep():
  ...
  T.start_timer('gemmini')
  T.add_body([f'matmul_c_i32_d_i32_rep({NN}, {MM}, {KK}, a_scale, b_scale, d_scale, 0, 0, 0, x, y, z_gemmini, d);',
              f'gemmini_fence();',
              f''])
  T.stop_timer('gemmini', 'Cycles for GEMMINI version')
...
def test_matmul_c_i8_d_i32_rep():
  ...
  def matmul_c_i8_d_i32_rep(
    ...
    if N%16 > 0:
        for j in par(0,M/16):
            ...
            for k in par(0,K/16):
                ...
                matmul_acc_i8(N%16,16,16, trans_a, trans_b, Ablock, Bblock, res)
    ...
    if M%16 > 0:
        for i in par(0,N/16):
            ...
            for k in par(0,K/16):
                ...
                matmul_acc_i8(16,M%16,16, trans_a, trans_b, Ablock, Bblock, res)
    ...
    if N%16 > 0 and M%16 > 0:
        ...
        for k in par(0,K/16):
            ...
            matmul_acc_i8(N%16,M%16,16, trans_a, trans_b, Ablock, Bblock, res)
  ...
  T.start_timer('gemmini')
  T.add_body([f'matmul_c_i8_d_i32_rep({NN}, {MM}, {KK}, a_scale, b_scale, c_scale, d_scale, zero, zero, zero, x, y, z_gemmini, d);',
              f'gemmini_fence();',
              f''])
  T.stop_timer('gemmini', 'Cycles for GEMMINI version')
