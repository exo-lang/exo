...
def test_conv_ae():
    ...
    gemmini = add_loop(gemmini, 'for kch_o in _:_ #0',
                                'orow_i', 28, guard=True)
    ...
    gemmini = add_loop(gemmini, 'for kch_o in _:_ #2',
                                'orow_i', 28, guard=True)
    ...
    gemmini = fusion(gemmini, 'for b in _:_ #0', 'for b in _:_ #1')
    gemmini = fusion(gemmini, 'for b in _:_ #0', 'for b in _:_ #1')
    gemmini = fusion(gemmini, 'for b in _:_ #0', 'for b in _:_ #1')
    gemmini = fusion(gemmini, 'for b in _:_ #0', 'for b in _:_ #1')
    ...
    gemmini = fusion(gemmini, 'for ocol_o in _:_ #0', 'for ocol_o in _:_ #1')
    gemmini = fusion(gemmini, 'for ocol_o in _:_ #0', 'for ocol_o in _:_ #1')
    ...
    gemmini = fusion(gemmini, 'for orow_o in _:_ #0', 'for orow_o in _:_ #1')
    gemmini = fusion(gemmini, 'for orow_o in _:_ #0', 'for orow_o in _:_ #1')
    ...
    gemmini = fusion(gemmini, 'for orow_i in _:_ #0', 'for orow_i in _:_ #1')
    gemmini = fusion(gemmini, 'for orow_i in _:_ #0', 'for orow_i in _:_ #1')

    gemmini = add_loop(gemmini, 'for och_o in _:_ #3', 'orow_o', 2)
    gemmini = fusion(gemmini, 'for orow_o in _:_ #1', 'for orow_o in _:_ #2')
    gemmini = fusion(gemmini, 'for orow_o in _:_ #1', 'for orow_o in _:_ #2')
    gemmini = add_loop(gemmini, 'for och_o in _:_ #3', 'orow_i', 28)
    gemmini = fusion(gemmini, 'for orow_i in _:_ #1', 'for orow_i in _:_ #2')
    gemmini = fusion(gemmini, 'for orow_i in _:_ #1', 'for orow_i in _:_ #2')

    gemmini = fusion(gemmini, 'for krow in _:_ #0', 'for krow in _:_ #1')
    gemmini = fusion(gemmini, 'for kcol in _:_ #0', 'for kcol in _:_ #1')
    gemmini = fusion(gemmini, 'for krow in _:_ #1', 'for krow in _:_ #2')
    gemmini = fusion(gemmini, 'for kcol in _:_ #1', 'for kcol in _:_ #2')
