  ...
  for (int jo=0; jo < 4; jo++) {
    ...
    for (int i=0; i < 8; i++) {
      for (int j=0; j < 8; j++) {
        ...
        gemmini_extended_mvin( 0, ((uint64_t) ((struct systl_win_2i32){ (int32_t*)((uint64_t)( ((uint32_t)((uint64_t)res)) + ((i + 0) * (8 * 16 * 16) + (j + 0) * (16 * 16) + (0 + 0) * (16) + (0 + 0) * (1))/16 )), { 16,1 } }).data),(16 + 0), (16 + 0) );
        for (int k=0; k < 32; k++) {
          ...
          gemmini_extended_mvin( ((struct systl_win_2i8){ A + (16 * i + 128 * io + 0 + 0) * (K) + (16 * k + 0 + 0) * (1), { K,1 } }).data, ((uint64_t) ((struct systl_win_2i8){ (int8_t*)((uint64_t)( ((uint32_t)((uint64_t)a)) + ((0 + 0) * (16) + (0 + 0) * (1))/16 )), { 16,1 } }).data), (16 + 0), (16 + 0) );
          gemmini_extended3_config_ld((M), (b_scale)[0], 0, 0);

          gemmini_extended_mvin( ((struct systl_win_2i8){ B + (16 * k + 0 + 0) * (M) + (128 * jo + 16 * j + 0 + 0) * (1), { M,1 } }).data, ((uint64_t) ((struct systl_win_2i8){ (int8_t*)((uint64_t)( ((uint32_t)((uint64_t)b)) + ((0 + 0) * (16) + (0 + 0) * (1))/16 )), { 16,1 } }).data), (16 + 0), (16 + 0) );
          gemmini_extended_config_ex(WS, 0, 0, 0, 1, 0, 0);

          gemmini_extended_preload((uint32_t)(((struct systl_win_2i8){ (int8_t*)((uint64_t)( ((uint32_t)((uint64_t)b)) + ((0 + 0) * (16) + (0 + 0) * (1))/16 )), { 16,1 } }).data), (uint32_t)(((struct systl_win_2i32){ (int32_t*)((uint64_t)( ((uint32_t)((uint64_t)res)) + ((i + 0) * (8 * 16 * 16) + (j + 0) * (16 * 16) + (0 + 0) * (16) + (0 + 0) * (1))/16 )), { 16,1 } }).data) | 0x40000000, (16 + 0), (16 + 0), (16 + 0), (16 + 0));
gemmini_extended_compute_preloaded((uint32_t)(((struct systl_win_2i8){ (int8_t*)((uint64_t)( ((uint32_t)((uint64_t)a)) + ((0 + 0) * (16) + (0 + 0) * (1))/16 )), { 16,1 } }).data), ~((uint32_t)0), (16 + 0), (16 + 0), 16, 16);
          gemm_free((uint64_t)(a));
          gemm_free((uint64_t)(b));
        }
        gemmini_extended_config_st((M), 0, (c_scale)[0]);

        gemmini_extended_mvout( ((uint64_t) ((struct systl_win_2i8){ C + (16 * i + 128 * io + 0 + 0) * (M) + (16 * j + 128 * jo + 0 + 0) * (1), { M,1 } }).data), (uint32_t) ((struct systl_win_2i32){ (int32_t*)((uint64_t)( ((uint32_t)((uint64_t)res)) + ((i + 0) * (8 * 16 * 16) + (j + 0) * (16 * 16) + (0 + 0) * (16) + (0 + 0) * (1))/16 )), { 16,1 } }).data, (16 + 0), (16 + 0) );
      }
    }
