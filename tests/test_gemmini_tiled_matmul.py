...
def test_matmul_c_i8_perfect():
    ...
    matmul_c_i8_perfect = matmul_c_i8_perfect.split('k', 4, ['ko', 'ki'], perfect=True)
    matmul_c_i8_perfect = matmul_c_i8_perfect.split('i #0', 2, ['io', 'ii'], perfect=True)
    matmul_c_i8_perfect = matmul_c_i8_perfect.split('j #0', 2, ['jo', 'ji'], perfect=True)
    matmul_c_i8_perfect = matmul_c_i8_perfect.reorder('ki', 'jo')
    matmul_c_i8_perfect = matmul_c_i8_perfect.reorder('ji', 'io')
    matmul_c_i8_perfect = matmul_c_i8_perfect.reorder('ki', 'io')
    matmul_c_i8_perfect = matmul_c_i8_perfect.unroll('ii #0')
    matmul_c_i8_perfect = matmul_c_i8_perfect.unroll('ji #0')
