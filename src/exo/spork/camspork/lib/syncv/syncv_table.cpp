...
struct SyncvTable
{
    ...
    bool visible_to(const VisRecord& vis_record, const ThreadCuboid& cuboid, qual_bits_t want_qual_bits)
    {
            ...
            Logger&& logger)
    {
        ...
        auto check = [&] (node_id id, size_t linear_index)
        {
            ...
            while (mutate_id) {
                ...
                if (!visible_to(mutate_record, cuboid, q_input.extended_qual_bits)) {
            ...
            if constexpr (IsMutate) {
                ...
                while (read_id) {
                    ...
                    if (!visible_to(read_record, cuboid, q_input.extended_qual_bits)) {
