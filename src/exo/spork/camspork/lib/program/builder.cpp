...
camspork::Varname camspork_add_variable(
...
camspork::ExprRef camspork_add_Const(
...
camspork::ExprRef camspork_add_USub(
    camspork::ProgramBuilder *p_builder, camspork::ExprRef arg) {
  CAMSPORK_API_PROLOGUE
...
camspork::TrailingBarrierExprRef camspork_add_TrailingBarrierExpr(
    camspork::ProgramBuilder *p_builder, camspork::Varname name,
...
camspork::StmtRef camspork_add_SyncEnvAccessSingle(
    camspork::ProgramBuilder *p_builder, camspork::Varname name,
    ...
    camspork::TrailingBarrierExprRef trailing_barrier_expr) {
  CAMSPORK_API_PROLOGUE
  return p_builder->add_SyncEnvAccess(name, num_idx, idx, initial_qual_bit,
      ...
      access_flags, trailing_barrier_expr);
  CAMSPORK_API_EPILOGUE(camspork::StmtRef())
}

camspork::StmtRef camspork_add_SyncEnvAccessWindow(
    camspork::ProgramBuilder *p_builder, camspork::Varname name,
...
camspork::StmtRef camspork_add_SyncEnvAccessMulticast(
    camspork::ProgramBuilder *p_builder, camspork::Varname name,
    uint32_t num_idx, const camspork::ArriveIdx *idx,
    camspork::qual_bits_t initial_qual_bit,
    camspork::qual_bits_t extended_qual_bits,
...
camspork::StmtRef camspork_add_SyncEnvFreeShard(
    camspork::ProgramBuilder *p_builder, camspork::Varname name,
    uint32_t num_idx, const camspork::ExprRef *idx,
    camspork::qual_bits_t extended_qual_bits) {
  CAMSPORK_API_PROLOGUE
...
camspork::StmtRef camspork_add_MutateValue(camspork::ProgramBuilder *p_builder,
    camspork::Varname name, uint32_t num_idx, const camspork::ExprRef *idx,
    camspork::binop op, camspork::ExprRef rhs) {
  CAMSPORK_API_PROLOGUE
...
camspork::StmtRef camspork_add_Arrive(camspork::ProgramBuilder *p_builder,
    camspork::qual_bits_t L1_qual_bits, camspork::Varname name,
    uint32_t num_idx, const camspork::ArriveIdx *idx) {
  CAMSPORK_API_PROLOGUE
...
camspork::StmtRef camspork_add_ValueEnvAlloc(
    camspork::ProgramBuilder *p_builder, camspork::Varname name,
...
camspork::StmtRef camspork_add_SyncEnvAlloc(camspork::ProgramBuilder *p_builder,
    camspork::Varname name, uint32_t num_dims,
    const camspork::ExprRef *extent) {
  CAMSPORK_API_PROLOGUE
  return p_builder->add_SyncEnvAlloc(name, num_dims, extent);
  CAMSPORK_API_EPILOGUE(camspork::StmtRef())
}

camspork::StmtRef camspork_add_ExpectSyncEnvAlloc(
    camspork::ProgramBuilder *p_builder, camspork::Varname name,
    uint32_t num_dims, const camspork::ExprRef *extent) {
  CAMSPORK_API_PROLOGUE
...
camspork::StmtRef camspork_add_BarrierEnvAlloc(
    camspork::ProgramBuilder *p_builder, camspork::Varname name,
    uint32_t num_dims, const camspork::ExprRef *extent) {
  CAMSPORK_API_PROLOGUE
...
camspork::StmtRef camspork_add_DataFree(
    camspork::ProgramBuilder *p_builder, camspork::Varname name) {
  CAMSPORK_API_PROLOGUE
...
camspork::StmtRef camspork_add_BarrierFree(
    camspork::ProgramBuilder *p_builder, camspork::Varname name) {
  CAMSPORK_API_PROLOGUE
...
camspork::StmtRef camspork_add_JoinThreads(
...
camspork::StmtRef camspork_push_If(
...
camspork::StmtRef camspork_push_ParallelBlock(
...
camspork::StmtRef camspork_push_DomainReshape(
    camspork::ProgramBuilder *p_builder, uint32_t dim, const uint32_t *domain) {
  CAMSPORK_API_PROLOGUE
