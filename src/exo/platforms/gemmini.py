...
_gemm_ld_i8_block_id1 = ("gemmini_extended3_config_ld({src}.strides[0]*1, "+
                         ...
                         "gemmini_extended_mvin2( &{src_data}, "+
                                  "((uint64_t) &{dst_data}), 16*{m}, {n} );")
_gemm_ld_i8_block_id2 = ("gemmini_extended4_config_ld({src}.strides[0]*1, "+
                         "1.0f, 0, {n}, 2);\n"+
...
ld_i8_block_id1_v2      = make_ld_i8_block("ld_i8_block_id1_v2", 1,
                                           stride_val="stride(src,0)")
ld_i8_block_id1_s2_v2   = make_ld_i8_block("ld_i8_block_id1_s2_v2", 1,
                                           stride_val="stride(src,2)")

ld_i8_block_id2         = make_ld_i8_block("ld_i8_block_id2", 2)
ld_i8_block_id2_v2      = make_ld_i8_block("ld_i8_block_id2_v2", 2,
                                           stride_val="stride(src,0)")
ld_i8_block_id2_s2_v2   = make_ld_i8_block("ld_i8_block_id2_s2_v2", 2,
                                           stride_val="stride(src,2)")
